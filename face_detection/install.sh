...
if [ "$all_ok" = true ]; then
    ...
    echo "     python3 apps/quick_enroll.py --name \"Your Name\" --relationship \"Self\""
    echo ""
    echo "  2. Start the web interface:"
    echo "     python3 apps/web_app.py"
    echo "     Then open: http://localhost:5001"
    echo ""
    echo "  3. Or start the desktop app:"
    echo "     python3 apps/remind_assistant_v2.py"
    echo ""
    echo "📖 For detailed instructions, see:"
    echo "   - docs/README_V2.md (overview)"
